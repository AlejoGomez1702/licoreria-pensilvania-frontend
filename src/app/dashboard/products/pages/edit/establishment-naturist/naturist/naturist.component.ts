...
@Component({
  selector: 'app-naturist',
  templateUrl: './naturist.component.html',
  styleUrls: ['./naturist.component.scss']
})
export class NaturistComponent implements OnInit 
{
  ...
  onSubmit()
  {
    ...
    this.productService.updateProduct( this.product.id!, this.form.value, 'naturist ' ).subscribe(
      () => {
